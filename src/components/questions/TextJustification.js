...
function TextJustification() {
    const name = "Text Justification"
    const hashTags = "#helper functions"
    const headerSignature = "public List<String> fullJustify(String[] words, int maxWidth)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Given an array of words and a width maxWidth, format the text such that each line has exactly maxWidth characters and is fully (left and right) justified.\n \
    ...
    return (
        <div>
            <p>This question is too hard. I'm still working on it...</p>
