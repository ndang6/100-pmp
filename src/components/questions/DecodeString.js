...
function DecodeString() {
    const name = "Decode String"
    const hashTags = "#stack"
    const headerSignature = "public String decodeString(String s)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "The encoding rule is: k[encoded_string].\n \
                    k is a positive integer, and encoded_string will repeat k times.\n"
