...
function ReverseLinkedList() {
    const name = "Reverse Linked List"
    const hashTags = "#linked list"
    const headerSignature = "public ListNode reverseList(ListNode head)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Reverse a singly linked list.\n"
    ...
    // &lt;
    const hint1 = <p>You don't need any hint</p>
    const hint2 = <p>You can do it</p>
    const hint3 = <p>Try one more time!</p>
