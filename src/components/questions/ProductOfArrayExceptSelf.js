...
function ProductOfArrayExceptSelf() {
    ...
    const headerSignature = "public int[] productExceptSelf(int[] nums)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Given an array nums of n integers where n > 1,\n \
    ...
    // &lt;
    const hint1 = <p>int left = 1, right = 1;</p>
    const hint2 = <p>for (int i = 0; i &lt; n; i++) ...</p>
    const hint3 = <p>for (int i = n - 1; i &gt;= 0; i--) ...</p>
