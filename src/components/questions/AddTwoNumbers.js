...
function AddTwoNumbers() {
    ...
    const hashTags = "#singly-linked list"
    const headerSignature = "public ListNode addTwoNumbers(ListNode l1, ListNode l2)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "You are given two non-empty linked lists representing two non-negative integers.\n \
    ...
    // &lt;
    const hint1 = <p>ListNode dummyHead = new ListNode(0);{"\n"}ListNode runner = dummyHead;</p>
    const hint2 = <p>while(l1 != null || l2 != null)</p>
    const hint3 = <p>if(sum  &gt;= 10) runner.next = new ListNode(1)</p>
