...
function ConsecutiveNumbersSum() {
    const name = "Consecutive Numbers Sum"
    const hashTags = "#Math"
    const headerSignature = "public int consecutiveNumbersSum(int N)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Given a positive integer N, how many ways can we write it as a sum of consecutive positive integers?\n"
    ...
    // &lt;
    const hint1 = <p>for(int i = 1; ; i++)</p>
    const hint2 = <p>if( (N - sum) % i == 0) ...</p>
    const hint3 = <p>if(sum &gt;= N) break</p>
