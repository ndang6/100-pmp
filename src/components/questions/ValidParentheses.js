...
function ValidParentheses() {
    ...
    const hashTags = "#stack"
    const headerSignature = "public boolean isValid(String s)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Given a string s containing just the characters '(', ')', '{', '}', '[' and ']', determine if the input string is valid.\n"
    ...
    // &lt;
    const hint1 = <p>for(char c : s.toCharArray()) ...</p>
    const hint2 = <p>5 scenarios inside the for loop</p>
    const hint3 = <p>return stack.isEmpty();</p>
