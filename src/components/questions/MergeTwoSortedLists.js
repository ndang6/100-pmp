...
function MergeTwoSortedLists() {
    const name = "Merge Two Sorted Lists"
    const hashTags = "#dummy node"
    const headerSignature = "public ListNode mergeTwoLists(ListNode l1, ListNode l2)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Merge two sorted linked lists and return it as a new sorted list.\n \
    ...
    // &lt;
    const hint1 = <p>ListNode dummy = new ListNode(0);{"\n"}ListNode curr = dummy;</p>
    const hint2 = <p>while(l1 != null &amp;&amp; l2 != null) ... </p>
    const hint3 = <p>curr.next = l1 == null ? l2 : l1;</p>
