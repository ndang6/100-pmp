...
function LongestSubstringWithoutRepeatingCharacters() {
    const name = "Longest SubString Without Repeating Characters"
    const hashTags = "#hash map"
    const headerSignature = "public int lengthOfLongestSubstring(String s)"

    // \n
    // eslint-disable-next-line no-multi-str
    const prompt = "Given a string s, find the length of the longest substring without repeating characters."
    ...
    // &lt;
    const hint1String = "HashMap<Character, Integer> map"
    const hint1 = <p>{hint1String}</p>
    const hint2 = <p>j = 0, j = Math.max</p>
    const hint3 = <p>map.containsKey, map.put, map.get</p>
