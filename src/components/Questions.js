...
function Questions() {
    var names = ["Two Sum", "Add Two Numbers", "Number Of Islands", "Longest Palindromic Substring"]
            ...
            {names.map(function(name, index){
                return(
                    <div className='box-field'>                       
                        ...
                        <Link to={'/page2/' + name.toLowerCase().replaceAll(" ", "-")}><i class="fas fa-biking"></i></Link>
                    </div> 
                )
            })}                 
        </div>        
